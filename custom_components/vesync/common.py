...
from pyvesyncakerl.vesyncfan import model_features as fan_model_features
from pyvesyncakerl.vesynckitchen import model_features as kitchen_model_features
